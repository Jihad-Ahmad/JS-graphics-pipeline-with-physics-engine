...
function ballAllPhys(objptr)
{
	...
	if(collided)
	{
	 	//f2 = objptr.appliedForces[1][1](objptr);
		//console.log("f vs f2 = ("+f.x+","+f.y+","+f.z+")  vs ("+f2.x+","+f2.y+","+f2.z+")" );
...
//console.log("rx ("+rx.x+","+rx.y+","+rx.z+"), normaly ("+neg_normaly.x+","+neg_normaly.y+","+neg_normaly.z+"),  num="+num);
//console.log("ry ("+ry.x+","+ry.y+","+ry.z+"), normaly ("+neg_normaly.x+","+neg_normaly.y+","+neg_normaly.z+"),  num="+num);
//console.log("rz ("+rz.x+","+rz.y+","+rz.z+"), normaly ("+neg_normaly.x+","+neg_normaly.y+","+neg_normaly.z+"),  num="+num);
